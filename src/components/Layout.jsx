    ...
    <div style={s.shell}>
      <nav style={s.nav}>
        <div style={s.navLeft}>
          ...
          <NavLink to="/" style={({ isActive }) => ({ ...s.link, ...(isActive ? s.linkActive : {}) })}>
            + Novo contrato
          </NavLink>
...
const s = {
  ...
  nav: { background: "#fff", borderBottom: "1px solid #e5e7eb", padding: "0 1.5rem", height: "52px", display: "flex", alignItems: "center", justifyContent: "space-between" },
